...
💡 En caso de que sea necesario duplicar el componente o pasar propiedades directamente a través del tema, deberá ser declarado en la raíz del archivo JSON y recibir un bloque con los componentes necesarios para su funcionamiento.
